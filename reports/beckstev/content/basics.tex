...
in Abbildung \ref{fig:beispielhafte_netz_architecture}.
 ...
 in Abbildung \ref{fig:MiniDogNN} schmeatisch dargestellt ist. In der Abbildung sind
...
\begin{equation}
  ...
  n\ua{train}(\mathrm{rgb}) = 47255 \quad \mathrm{PreDogNN}, \qquad
...
keine spezielle und keine Gewichtsinitalisierung. Alsk Aktivierungsfunktion
für die Ausgabelage wird eine \textsc{sigmoid}-Funktion verwendet, da diese
einen Ausgabewert zwischen Null und Eins besitzt. Diese Eigenschaft ist nützlich,
weil die normierten Pixelwerte in diesem Bereich liegen und das Bild mit dieser
Lage rekonstuiert sein sollte.
Im Gegensatz zu den bisher vorgestellten NN, wird hier
\emph{padding} verwendet. Durch das \emph{padding} bleibt die Bildgröße
bei Konvolutionallagen erhalten. Eine schematische Darstellung des Autoencoders
