...
if __name__ == '__main__':
    ...
    if init:
        eval.predict(args.model_path, args.prediction_path, args.encoder_model,
                     fname_pred)
    ...
    # Multiclass-Analyse
    eval.prob_multiclass(Y_pred, Y_test, label=10, path=args.prediction_path)
    ...
    eval.plot_confusion_matrix(confusion_mtx, classes=range(120), path=args.prediction_path)
