...
def train_random_forest(training_parameters, grid_search):
    ...
    y_train_data, _ = eval_rf.get_true_labels_and_img_paths(trainDataloader, X_train_data.shape[0])
    y_val_data, _ = eval_rf.get_true_labels_and_img_paths(valDataloader, X_val_data.shape[0])
