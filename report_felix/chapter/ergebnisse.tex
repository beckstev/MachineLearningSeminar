...
In \autoref{loss-acc-predog} sind die Loss und Accuracy Kurven für \PreDog zu sehen.
...
\begin{figure}
  ...
  \label{loss-acc-predog}
\end{figure}

Die Confusion-Matrix in \autoref{confusion-predog} zeigt, dass das Training sehr gut
...
\begin{figure}
  ...
  \label{confusion-predog}
\end{figure}

\section{RF}

In \autoref{loss-acc-rf} sind die Loss und Accuracy Kurven für den Autoencoder
